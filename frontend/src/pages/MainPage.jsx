  ...
  return (
    <div className="min-h-screen bg-[#050508] text-white font-sans selection:bg-indigo-500/30">
      ...
      <nav className="flex items-center justify-between px-6 py-6 max-w-7xl mx-auto">
        ...
        <button onClick={()=>{navigate("/start")}} className="bg-[#4f46e5] hover:bg-[#5a52ff] text-white px-5 py-2 rounded-lg text-sm font-semibold transition-all shadow-lg shadow-indigo-500/20">
          Start Chat
        </button>
      </nav>
      ...
      <section className="pt-24 pb-32 px-6 text-center max-w-4xl mx-auto">
        <span className="text-[10px] uppercase tracking-[0.2em] text-indigo-400 font-bold mb-6 block">
          Private by default
        </span>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button onClick={()=>{navigate("/start")}} className="w-full sm:w-auto bg-[#4f46e5] hover:bg-[#5a52ff] text-white px-8 py-4 rounded-xl font-bold transition-all">
            Start Chat
          </button>
        </div>
      </section>
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <span className="text-[10px] uppercase tracking-[0.2em] text-indigo-400 font-bold mb-4 block">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          />
          <FeatureCard 
            icon={<UserX className="w-5 h-5 text-indigo-400" />}
      ...
      <section className="py-20 px-6 max-w-6xl mx-auto">
        <div className="bg-[#0a0a0f] border border-white/5 rounded-[2rem] p-12 md:p-20 text-center relative overflow-hidden">
          {/* Subtle Glow Effect */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full bg-indigo-500/5 blur-[120px] pointer-events-none"></div>
          
          <span className="text-[10px] uppercase tracking-[0.2em] text-indigo-400 font-bold mb-6 block relative z-10">
          ...
          <button onClick={()=>{navigate("/start")}} className="bg-white text-black hover:bg-gray-200 px-10 py-4 rounded-xl font-bold transition-all relative z-10">
            Start Chat
          </button>
        </div>
      </section>
...
const FeatureCard = ({ icon, title, description }) => (
  <div className="bg-[#0d0d12] border border-white/5 p-8 rounded-2xl hover:border-white/10 transition-colors group">
